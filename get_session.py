...
def get_wisedu_session_webvpn(url, no, pwd, s=get_session(), captcha_retry=99, remember_me=True):
    """
    对接"金智教务统一登录系统"的API.
    ...
    def retry(session):
        ...
        test_url = 'https://webvpn.njit.edu.cn/http/77726476706e69737468656265737421f1e2559434357a467b1ac7a2925c377b8e5b5f183329/authserver/index.do'
        res = s.get(test_url)
