...
institution = 'webvpn.njit.edu.cn'   # Change the hostname here like 'webvpn.xxx.edu.cn'
...
if __name__ == '__main__':
    ...
    #直观体验一下
    #转vpn_url
    url = 'http://202.119.161.130/'
    print('From ordinary url: \n' + getVPNUrl(url))
    #https://webvpn.njit.edu.cn/http/77726476706e69737468656265737421a2a713d27661311e2f5ed8e2c90673/
    ...
    #https://kns.cnki.net/KCMS/detail/detail.aspx?dbcode=CJFQ&dbname=CJFD2007&filename=JEXK200702000&uid=WEEvREcwSlJHSldRa1FhcTdnTnhXY20wTWhLQWVGdmJFOTcvMFFDWDBycz0=$9A4hF_YAuvQ5obgVAqNKPCYcEjKensW4IQMovwHtwkF4VYPoHbKxJw!!&v=MTYzNjU3cWZaT2RuRkNuaFZMN0tMeWpUWmJHNEh0Yk1yWTlGWklSOGVYMUx1eFlTN0RoMVQzcVRyV00xRnJDVVI=
